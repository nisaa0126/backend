...
const mongoUrl = "mongodb+srv://deciarti75:admin@cluster0.8t9bemv.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/updateschedule", async (req, res) => {
      const { scheduleId, no, nama, nohp } = req.body;
